  ...
  private vacancies = new BehaviorSubject<Vacancy[]>([
    {
      ...
      educationAndQualification: [
        'Среднее специальное или высшее образование, предпочтительно в сфере экономики, финансов или бухгалтерского учета.',
        'Курсы по работе с кассовыми аппаратами и платежными системами будут преимуществом.',
      ],
      workExperience: [
        'Опыт работы на наличной денежной деятельности от 1 года.',
        'Опыт работы с наличными денежными средствами, валютными операциями и банковскими услугами.',
      ],
      skillsAndKnowledge: [
