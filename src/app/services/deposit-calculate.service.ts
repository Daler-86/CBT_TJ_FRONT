...
export class DepositCalculateService {
  private readonly DEPOSIT_PRODUCTS: DepositProducts = {
    "2": {
        ...
        currencies: {
            "TJS": { 
                minAmount: 1000, maxAmount: 100000, stepAmount: 1000, amountLabels: ['1 тыс.', '25 тыс.', '50 тыс.', '75 тыс.', '∞'],
            ...
            "USD": {
                minAmount: 100, maxAmount: 10000, stepAmount: 100, amountLabels: ['$100', '$2.5k', '$5k', '$7.5k', '∞' ],
                minTerm: 6, maxTerm: 48, stepTerm: 1, termLabels: ['6 мес.', '18 мес.', '36 мес.', '48 мес.'],
    ...
    "1": {
        ...
        currencies: {
            "TJS": {
                minAmount: 500, maxAmount: 50000, stepAmount: 500, amountLabels: ['500', '10 тыс.', '25 тыс.', '∞'],
            ...
            "USD": {
                minAmount: 50, maxAmount: 5000, stepAmount: 50, amountLabels: ['$50', '$1k', '$2.5k', '∞'],
                minTerm: 12, maxTerm: 72, stepTerm: 1, termLabels: ['1 год', '3 года', '5 лет', '6 лет'],
    ...
    "4": {
        ...
        currencies: {
            "TJS": {
                minAmount: 1000, maxAmount: 50000, stepAmount: 500, amountLabels: ['1 тыс.', '10 тыс.', '25 тыс.', '∞'],
    ...
    "3": {
        ...
        currencies: {
            "TJS": {
                minAmount: 500000, maxAmount: 5000000, stepAmount: 10000, amountLabels: ['500 тыс.', '1.5 млн', '3 млн', '∞'],
            ...
            "USD": {
                minAmount: 100000, maxAmount: 1000000, stepAmount: 5000, amountLabels: ['$100k', '$250k', '$500k', '∞'],
                minTerm: 12, maxTerm: 60, stepTerm: 1, termLabels: ['1 год', '2 года', '3 года', '5 лет'],
    ...
    "5": {
        ...
        currencies: {
            "TJS": {
                minAmount: 1000, maxAmount: 1000000, stepAmount: 1000, amountLabels: ['1 тыс.', '250 тыс.', '500 тыс.', '∞'],
            ...
            "USD": {
                minAmount: 100, maxAmount: 100000, stepAmount: 100, amountLabels: ['$100', '$25k', '$50k', '∞'],
                minTerm: 12, maxTerm: 36, stepTerm: 1, termLabels: ['1 год', '1.5 года', '2.5 года', '3 года'],
