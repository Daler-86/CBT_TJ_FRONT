    ...
    '2': {
      ...
      currencies: {
        TJS: {
          ...
          maxAmount: 10000000,
          stepAmount: 1000,
          amountLabels: ['1 тыс.', '25 тыс.', '50 тыс.', '75 тыс.', '∞'],
          minTerm: 6,
          maxTerm: 48,
          stepTerm: 1,
          termLabels: ['6 мес.', '18 мес.', '36 мес.', '48 мес.'],
          rates: [
            { minMonths: 13, rate: 0.11 },
            { minMonths: 12, rate: 0.09 },
            { minMonths: 9, rate: 0.07 },
        ...
        USD: {
          ...
          maxAmount: 10000000,
          stepAmount: 100,
          amountLabels: ['$100', '$2.5k', '$5k', '$7.5k', '∞'],
          minTerm: 6,
          maxTerm: 48,
          stepTerm: 1,
          termLabels: ['6 мес.', '18 мес.', '36 мес.', '48 мес.'],
          rates: [
            { minMonths: 13, rate: 0.05 },
            { minMonths: 12, rate: 0.04 },
            { minMonths: 9, rate: 0.02 },
            { minMonths: 6, rate: 0.01 },
          ],
        },
      },
    },
    '1': {
      ...
      currencies: {
        TJS: {
          ...
          maxAmount: 10000000,
          stepAmount: 500,
          amountLabels: ['500', '10 тыс.', '25 тыс.', '∞'],
          minTerm: 12,
          maxTerm: 72,
          stepTerm: 1,
          termLabels: ['1 год', '3 года', '5 лет', '6 лет'],
          rates: [
            { minMonths: 25, rate: 0.11 },
            { minMonths: 24, rate: 0.1 },
            { minMonths: 12, rate: 0.09 },
          ],
        },
        USD: {
          ...
          maxAmount: 10000000,
          stepAmount: 50,
          amountLabels: ['$50', '$1k', '$2.5k', '∞'],
          minTerm: 12,
          maxTerm: 72,
          stepTerm: 1,
          termLabels: ['1 год', '3 года', '5 лет', '6 лет'],
          rates: [
            { minMonths: 25, rate: 0.07 },
            { minMonths: 24, rate: 0.05 },
            { minMonths: 12, rate: 0.04 },
          ],
        },
      },
    ...
    '4': {
      ...
      currencies: {
        TJS: {
          ...
          maxAmount: 10000000,
          stepAmount: 500,
          amountLabels: ['1 тыс.', '10 тыс.', '25 тыс.', '∞'],
          minTerm: 6,
          maxTerm: 12,
          stepTerm: 1,
          termLabels: ['6 мес.', '9 мес.', '12 мес.'],
          rates: [
            { minMonths: 12, rate: 0.09 },
            { minMonths: 9, rate: 0.06 },
            { minMonths: 6, rate: 0.04 },
          ],
        },
        USD: null,
      },
    ...
    '3': {
      ...
      currencies: {
        TJS: {
          ...
          maxAmount: 10000000,
          stepAmount: 10000,
          amountLabels: ['500 тыс.', '1.5 млн', '3 млн', '∞'],
          minTerm: 12,
          maxTerm: 60,
          stepTerm: 1,
          termLabels: ['1 год', '2 года', '3 года', '5 лет'],
          rates: [
            { minMonths: 37, rate: 0.12 },
            { minMonths: 24, rate: 0.11 },
            { minMonths: 12, rate: 0.1 },
          ],
        },
        USD: {
          minAmount: 100000,
          maxAmount: 10000000,
          stepAmount: 5000,
          amountLabels: ['$100k', '$250k', '$500k', '∞'],
          minTerm: 12,
          maxTerm: 60,
          stepTerm: 1,
          termLabels: ['1 год', '2 года', '3 года', '5 лет'],
          rates: [
            { minMonths: 37, rate: 0.08 },
            { minMonths: 24, rate: 0.07 },
            { minMonths: 12, rate: 0.06 },
          ],
        },
      },
    },
    '5': {
      ...
      currencies: {
        TJS: {
          ...
          maxAmount: 10000000,
          stepAmount: 1000,
          amountLabels: ['1 тыс.', '250 тыс.', '500 тыс.', '∞'],
          minTerm: 12,
          maxTerm: 36,
          stepTerm: 1,
          termLabels: ['1 год', '1.5 года', '2.5 года', '3 года'],
          rates: [
            { minMonths: 24, rate: 0.11 },
            { minMonths: 12, rate: 0.1 },
          ],
  ...
  calculateDeposit(params: CalculationParams): CalculationResult {
    ...
    if (!product) {
      return {
        ...
        error: `Продукт с ID ${params.productId} не найден`,
      };
    }
    ...
    if (!conditions) {
      return {
        ...
        income: 0,
        totalAmount: params.amount,
        error: `Продукт недоступен в ${params.currency}`,
      };
    }
    if (params.amount < conditions.minAmount) {
      return {
        ...
        income: 0,
        totalAmount: params.amount,
        error: `Мин. сумма: ${new Intl.NumberFormat('ru-RU').format(conditions.minAmount)} ${params.currency}`,
      };
    }
    if (params.termMonths < conditions.minTerm) {
      return {
        ...
        income: 0,
        totalAmount: params.amount,
        error: `Мин. срок: ${conditions.minTerm} мес.`,
      };
    }
