...
export class VacanciesService {
  ...
  uploadFile(file: File): Observable<fileVacancyResponse> {
    ...
    return this.http.post<fileVacancyResponse>(this.baseUrl + '/file/upload', uploadData, { headers });
  }

  submitFormData(formData: vacancySubmit): Observable<fileResponse> {
    return this.http.post<fileResponse>(this.baseUrl + '/vacancy/order/save', formData);
  }
}
